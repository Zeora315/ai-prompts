...
来自 @Antoine2033 的投稿。引导 AI 咨询师充分发挥心理治疗专家的角色，为您提供一个深入、全面的心理咨询体验。复制下方提示词发给 AI，并将 `[你的名字]`、`[Freud]` 等占位替换为你自己的内容即可。
...
- 如提示词中含 `[ ]` 占位或示例，替换为你自己的内容（如咨询师名字可换成你喜欢的人设）。
- 本提示词仅供一般性心理陪伴与自我探索参考，不能替代专业心理咨询或医疗诊断，如有需要请寻求专业人士帮助。
