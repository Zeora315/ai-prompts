...
引导你一步步复盘已完成的 project，提取经验教训，沉淀可供未来参考的改进措施。按 Workflow 逐阶段推进，每个阶段完成后会向你确认是否进入下一步。
...
- 先向 AI 简述项目背景与大致范围，它会引导你逐阶段复盘。
- 每完成一个阶段，AI 会询问是否进入下一步，按需补充信息即可。
- 想直接看成稿可说「跳过确认，直接生成完整复盘报告」。
- 报告偏短时可追加「扩展到 1500 字，补充更多细节与专业术语」。
